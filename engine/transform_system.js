var Jabaku = (function(module) {
	...
	function TransformSystem() {
		this._components = new Jabaku.IdContainer();
	}
	TransformSystem.extends(Object, {
		add: function(id, pos, rot, scale) {
			return this._components.add(id, new Transform(pos, rot, scale));
		},
		get: function(id) {
